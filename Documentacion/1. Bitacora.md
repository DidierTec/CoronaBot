...
* Se realizo una llamada para presentar el repositorio listo al maestro Cambranes y el maestro Jose Luis con el fin de aclarar dudas y ellos den su punto de vista ycomo modificaciones a realizar. Entre estas modificaciones se pidio realizar Casos de uso y con su respectivo diagrama de casos de uso. Los cuales se realizaron al terminar la presentacion.

**FECHA:** 29 de Noviembre  del 2020 
* Se realiza una llamada con los integrantes del equipo para ensayar la presentacion ante la clase. 

**Pendiente:**
- Realizar realizar la presentacion ante la clase.
